...
- **2026.04.01 – 2027.03.31**: Academic Assistant, Kyoto University, Japan
  - Supported research activities for the ArCS-III project.
  - Assisted with research on large-scale visualization and application of terrestrial environmental changes affecting the human sphere.

# Technical Skills

- **Programming Languages**: JavaScript (Google Earth Engine), Python, C language (VISIT model-based analysis)  
